...
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, 'js', 50, 1, 'http://localhost:3000/vedio/vedio152397621551516102.mp4', 0, 'http://localhost:3000/course_cover/course_cover152352310268712152.jpeg', 'JavaScript一种直译式脚本语言，是一种动态类型、弱类型、基于原型的语言，内置支持类型。它的解释器被称为JavaScript引擎，为浏览器的一部分，广泛用于客户端的脚本语言，最早是在HTML（标准通用标记语言下的一个应用）网页上使用，用来给HTML网页增加动态功能。11', 0);
...
INSERT INTO `course` VALUES (3, 'html', 0, 1, 'http://localhost:3000/vedio/vedio152397619691114292.mp4', 1, 'http://localhost:3000/course_cover/course_cover152352235899618006.jpeg', '超文本标记语言，标准通用标记语言下的一个应用。\n“超文本”就是指页面内可以包含图片、链接，甚至音乐、程序等非文字元素。', 0);
...
INSERT INTO `token` VALUES (65, '1523858542955', 1524463342955, 1);
INSERT INTO `token` VALUES (66, '1523875221497', 1524480021497, 1);
INSERT INTO `token` VALUES (67, '1523927631793', 1524532431793, 1);
