...
-- ----------------------------
BEGIN;
INSERT INTO `course` VALUES ('1', 'js', '10313123', '1', 'http://localhost:3000/vedio/js.mp4', '0', 'http://localhost:3000/course_cover/course_cover152352310268712152.jpeg', 'JavaScript一种直译式脚本语言，是一种动态类型、弱类型、基于原型的语言，内置支持类型。它的解释器被称为JavaScript引擎，为浏览器的一部分，广泛用于客户端的脚本语言，最早是在HTML（标准通用标记语言下的一个应用）网页上使用，用来给HTML网页增加动态功能。11', '0'), ('2', 'css', '3', '1', 'http://localhost:3000/vedio/css.mp4', '1', 'http://localhost:3000/course_cover/course_cover152352239138212722.jpeg', '层叠样式表(英文全称：Cascading Style Sheets)是一种用来表现HTML（标准通用标记语言的一个应用）或XML（标准通用标记语言的一个子集）等文件样式的计算机语言。', '0'), ('3', 'html', '0', '1', 'http://localhost:3000/vedio/html.mp4', '1', 'http://localhost:3000/course_cover/course_cover152352235899618006.jpeg', '超文本标记语言，标准通用标记语言下的一个应用。\n“超文本”就是指页面内可以包含图片、链接，甚至音乐、程序等非文字元素。', '0'), ('4', '数据结构', '20', '2', 'http://localhost:3000/vedio/数据结构.mp4', '1', 'http://localhost:3000/course_cover/course_cover152352236540513063.jpeg', '数据结构是计算机存储、组织数据的方式。数据结构是指相互之间存在一种或多种特定关系的数据元素的集合。通常情况下，精心选择的数据结构可以带来更高的运行或者存储效率。数据结构往往同高效的检索算法和索引技术有关。', '0'), ('5', 'JAVA', '10', '3', 'http://localhost:3000/vedio/JAVA.mp4', '1', 'http://localhost:3000/course_cover/course_cover152352214380215349.jpg', 'Java是一门面向对象编程语言，不仅吸收了C++语言的各种优点，还摒弃了C++里难以理解的多继承、指针等概念，因此Java语言具有功能强大和简单易用两个特征。Java语言作为静态面向对象编程语言的代表，极好地实现了面向对象理论，允许程序员以优雅的思维方式进行复杂的编程', '0'), ('6', 'eqweqwewqe', '222', '2', 'http://localhost:3000/vedio/js.flv', '0', 'http://localhost:3000/admin_avatar/admin_avatar152352057939415677.jpg', 'wqeqwewqe2', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `course_favorite` VALUES ('1', '1', '1', '1523524612', '0'), ('2', '1', '2', '1523529999', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `news` VALUES ('1', '科大讯飞AIUI项目总监丁瑞：打造属于你的AI交互产品', '随着人工智能时代的快速到来，智能交互产品已经越来越多的进入千家万户。AI人机交互的痛点在哪里？如何打造一款属于你的AI交互产品呢？', '1', '50', 'http://localhost:3000/news_cover/news_cover152352402362410631.jpg', '0', '<h1 style=\"text-align: center;\">Welcome to the TinyMCE demo!</h1><p style=\"text-align: center; font-size: 15px;\"><img title=\"TinyMCE Logo\" src=\"//www.tinymce.com/images/glyph-tinymce@2x.png\" alt=\"TinyMCE Logo\" width=\"110\" height=\"97\" /><ul>\n        <li>Our <a href=\"//www.tinymce.com/docs/\">documentation</a> is a great resource for learning how to configure TinyMCE.</li><li>Have a specific question? Visit the <a href=\"https://community.tinymce.com/forum/\">Community Forum</a>.</li><li>We also offer enterprise grade support as part of <a href=\"https://tinymce.com/pricing\">TinyMCE premium subscriptions</a>.</li>\n      </ul>'), ('2', '测试测试', '这个是测试用的', '1', '0', 'http://localhost:3000/news_cover/news_cover152352405649318122.jpeg', '0', '<!DOCTYPE html>\n<html>\n<head>\n</head>\n<body>\n<h1 align=\"center\"><b>测</b><i>试</i><u>富</u><strike>文</strike><font color=\"#993300\">本</font><font style=\"background-color: #ffff99;\">编</font><sub>辑</sub><sup>器</sup></h1>\n</body>\n</html>'), ('3', 'nodejs超牛逼', 'nodejs超牛逼', '1', '0', 'http://localhost:3000/news_cover/news_cover152352845244715554.jpeg', '0', '<!DOCTYPE html>\n<html>\n<head>\n</head>\n<body>\n<h1 align=\"center\">nodejs超牛逼</h1>\n</body>\n</html>');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `news_favorite` VALUES ('1', '1', '3', '1523524612', '0'), ('2', '2', '2', '1523529999', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `student` VALUES ('1', '张三', '13500000000', '100111', 'http://localhost:3000/stu_avatar/1.jpg', '1523352574', '1', '男', '000000', '0'), ('2', '李四', '15222222222', '100', 'http://localhost:3000/stu_avatar/2.jpg', '1523352614', '1', '男', '000000', '0'), ('3', '王五1', '13599999999', '200', 'http://localhost:3000/stu_avatar/stu_avatar152351937983813001.png', '1523352636', '1', '女', '000000', '0'), ('4', '赵六', '18966666666', '0', 'http://localhost:3000/stu_avatar/默认.jpg', '1523352665', '1', '男', '000000', '0');
COMMIT;
